...
public class SettingViewModel
{
    ...
    public Dictionary<(string, string), object> GetIniDictionary()
    {
        ...
        foreach (PropertyInfo property in properties)
        {
            ...
            IniSectionAttribute iniSectionAttribute = propertyValue.GetType().GetCustomAttribute<IniSectionAttribute>();
...
public class GameAndScoringType
{
    ...
    [IniField("BTGameType")] public byte GameType { get; set; }

    [BwsColumn("ScoringType")]
    [IniField("ScoringType")] public byte ScoringType { get; set; }

    [BwsColumn("PairsMoveAcrossField", "SESSION")]
    [IniField("ScoreAcross")] public bool ScoreAcrossPair { get; set; }
}
